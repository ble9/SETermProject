    ...
    getGeolocationData: function () {
        ...
        if ($("#txtStartingPoint").val() != "" && $("#txtDestinationPoint").val() != "") {
            ...
            bytutorialMap.codeAddress($("#txtStartingPoint").val()).then(function (response) {
                ...
                return $("#txtDestinationPoint").val().then(function (response) {
                    var geoData2 = {
                        latitude: response[0].geometry.location.lat(),
                        longitude: response[0].geometry.location.lng()
                    }
        ...
        bytutorialMap.initNavigateMap("map", "panel-direction", $("#txtDestinationPoint").val(), $("#txtStartingPoint").val(), $("#txtStartingPoint").val(), $("#txtDestinationPoint").val());
            });
        } else {
